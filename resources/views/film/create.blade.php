        ...
        <div class="p-6">
            <form method="POST" action="{{ route('film.store') }}">
                ...
                <div class="">
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Create Film</h3>
                        </div>
                        ...
                        <div class="">
                                ...
                                <div class="mt-1">
                                    <input type="text" name="film_name" id="film_name"
                                           autocomplete="film_name" value="{{ old('film_name') }}"
                        ...
                        <div class="">
                            <label for="start_date"
                                   class="block text-sm font-medium text-gray-700">Film Start Date</label>
                            <div class="mt-1">
                                <input type="date" name="start_date" id="start_date"
                                       autocomplete="start_date" value="{{ old('start_date') }}"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="">
                            <label for="end_date"
                                   class="block text-sm font-medium text-gray-700">Film End Date</label>
                            <div class="mt-1">
                                <input type="date" name="end_date" id="end_date"
                                       autocomplete="end_date" value="{{ old('end_date') }}"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">

<x-app-layout>
    ...
    <div class="max-w-5xl bg-white shadow-2xl rounded-lg mx-auto py-4 mt-10">
        <div class="p-6">
            <form method="POST" action="{{ route('cinema.update', $cinema) }}">
                @csrf
                @method('PUT')
                <div class="">
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Cinema</h3>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="mt-1">
                                <input type="text" name="cinema_name" id="cinema_name"
                                       autocomplete="cinema_name" value="{{ $cinema->name }}"
                        ...
                        <div class="">
                            ...
                            <div class="mt-1">
                                <input type="text" name="cinema_location" id="cinema_location"
                                       autocomplete="cinema_location" value="{{ $cinema->location }}"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">

<x-app-layout>
    ...
    <div class="max-w-7xl bg-white shadow-2xl rounded-lg mx-auto py-4 mt-10">
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('cinema-company.update', $cinemaCompany) }}">
                @csrf
                @method('PUT')
                <div class="">
                    <div class="space-y-6">
                        ...
                        <div class="">
                                ...
                                <div class="mt-1 sm:col-span-2 sm:mt-0">
                                    <input type="text" name="cinema-company" id="cinema-company"
                                           autocomplete="cinema-company" value="{{ $cinemaCompany->name }}"
                ...
                <div class="pt-5">
                    <div class="flex justify-end">
                        <button type="button"
                                onclick="location.href='{{ route('cinema-company.index') }}'"

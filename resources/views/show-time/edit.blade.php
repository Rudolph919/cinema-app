<x-app-layout>
    ...
    <div class="max-w-5xl bg-white shadow-2xl rounded-lg mx-auto py-4 mt-10">
        <div class="p-6">
            <form method="POST" action="{{ route('show-time.update', $show_time) }}">
                @csrf
                @method('PUT')
                <div class="">
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Show Time</h3>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="mt-1">
                                <input type="text" name="show_time_text" id="show_time_text"
                                       autocomplete="show_time_text" value="{{ $show_time->show_time_text }}"
                        ...
                        <div class="">
                            ...
                            <div class="mt-1">
                                <input type="text" name="show_time_value" id="show_time_value"
                                       autocomplete="show_time_value" value="{{ $show_time->show_time_value }}"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
